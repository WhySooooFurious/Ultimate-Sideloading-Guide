...
IF INSTALLING ONLY THE DNS, MAKE SURE TO DOWNLOAD THE PROFILE AND ENABLE FULLTRUST IN SETTINGS>GENERAL>ABOUT>CERTIFICATE TRUST SETTINGS AND ENABLE NEXTDNS
